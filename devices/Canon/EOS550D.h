...
class EOS550D {
 ...
 public:
  ...
  enum Aperture { F5_6, F6_3, F7_1, F8, F9, F10, F11, F13, F14, F16, F18, F20, F22, F25, F29, F32, F36};


  // all possible iso values, correct order, so we can call them by index
  enum Iso { ISOAUTO, ISO100, ISO200, ISO400, ISO800, ISO1600, ISO3200, ISO6400 };
