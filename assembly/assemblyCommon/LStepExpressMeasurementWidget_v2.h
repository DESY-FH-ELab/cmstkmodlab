#ifndef LSTEPEXPRESSMEASUREMENTWIDGET_V2_H
#define LSTEPEXPRESSMEASUREMENTWIDGET_V2_H
...
class LStepExpressMeasurementWidget_v2 : public QWidget
{
    Q_OBJECT

public:
    explicit LStepExpressMeasurementWidget_v2(LStepExpressModel* model, LaserModel* laserModel, LStepExpressMeasurement* measurement, LStepExpressMeasurementTable* table, QWidget *parent = 0);
    ~LStepExpressMeasurementWidget_v2();
...
#endif // LSTEPEXPRESSMEASUREMENTWIDGET_V2_H
