 ...
 , finder_connected_(false)
{
  ...
  if(config != nullptr)
  {
    ...
    assembly::QLineEdit_setText(patrecOne_wid_->threshold_lineEdit()        , config->getValue<int>("AlignmentCheckView_PatRec1_threshold"        , 83));
...
tRec1_angles_finestep", 0.2));
  ...
  if(config != nullptr)
  {
    ...
    assembly::QLineEdit_setText(patrecTwo_wid_->threshold_lineEdit()        , config->getValue<int>("AlignmentCheckView_PatRec2_threshold"        , 100));
...
QGroupBox* patrecThree_cfg_box = new QGroupBox(tr("PatRec Marker #3  [TL PS-S]"));
  ...
  if(config != nullptr)
  {
    ...
    assembly::QLineEdit_setText(patrecThree_wid_->threshold_lineEdit()        , config->getValue<int>("AlignmentCheckView_PatRec2_threshold"        , 85));
...
QGroupBox* patrecFour_cfg_box = new QGroupBox(tr("PatRec Marker #4  [TL PS-P]"));
  ...
  if(config != nullptr)
  {
    ...
    assembly::QLineEdit_setText(patrecFour_wid_->threshold_lineEdit()        , config->getValue<int>("AlignmentCheckView_PatRec2_threshold"        , 80));
