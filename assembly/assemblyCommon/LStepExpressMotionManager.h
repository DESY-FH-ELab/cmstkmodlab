...
class LStepExpressMotionManager : public QObject
{
 Q_OBJECT
  ...
  public:
    ...
    void     set_velocity_Z(const double velocity) const { this->model()->setVelocity(2, velocity); } //Fabio: don't fully understand how this could be declared const, but it works ;) 
