...
MicroDAQWidget::MicroDAQWidget(MicroDAQModel* daqModel, QWidget *parent) :
    QWidget(parent),
    daqModel_(daqModel)
{
...
void MicroDAQWidget::daqStateChanged(bool running)
{
    if (running) {
...
void MicroDAQWidget::logButtonClicked()
{
