...
MicroScriptWidget::MicroScriptWidget(MicroScriptModel* scriptModel,
                                     QWidget *parent) :
    QWidget(parent),
    scriptModel_(scriptModel)
{
    ...
    // script editor
    scriptEditor_ = new MicroScriptEdit(this);
    ...
    // message display
    messageDisplay_ = new MicroMessageDisplay(this);
...
void MicroScriptWidget::openScriptButtonClicked() {
...
void MicroScriptWidget::saveScriptButtonClicked() {
...
void MicroScriptWidget::saveAsScriptButtonClicked() {
...
void MicroScriptWidget::executeScriptButtonClicked() {

    scriptModel_->executeScript();
}

void MicroScriptWidget::abortScriptButtonClicked() {

    scriptModel_->abortScript();
}

void MicroScriptWidget::scriptChanged() {

}

void MicroScriptWidget::clearMessageText( ) {

    messageDisplay_->setPlainText("");
}

void MicroScriptWidget::appendMessageText( const QString & text ) {
