...
int main(int argc, char *argv[])
{
  ...
  QCoreApplication::setApplicationName("thermoDAQ2HDF5");
  ...
  parser.setApplicationDescription("Converts thermalDAQ XML data files to HDF5 files.");
  ...
  if (version=="2") {
    parser.addOption(QCommandLineOption("Keithley",
        "multimeter data triggers filling of hdf5 file (default)"));
    parser.addOption(QCommandLineOption("Huber",
        "chiller data triggers filling of hdf5 file"));
  }
  ...
  if (version=="1") {
    std::cout << "Parser for version 1 data not yet implemented -> exiting";
    return 0;
    /*
