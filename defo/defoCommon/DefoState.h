...
template <class Controller> class DefoAbstractDeviceModel {

public:
  explicit DefoAbstractDeviceModel() : controller_(NULL), state_(OFF) {}
  virtual ~DefoAbstractDeviceModel() { destroyController(); }
