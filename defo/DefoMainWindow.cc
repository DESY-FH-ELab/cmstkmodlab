...
//   surfacesZoomButton_->setArrowType(Qt::NoArrow);
  ...
  reddishnessGroupBox_ = new QGroupBox(rawimagerecoGroupBox_);
  reddishnessGroupBox_->setObjectName(QString::fromUtf8("reddishnessGroupBox_"));
  reddishnessGroupBox_->setGeometry(QRect(200, 40, 151, 81));
  reddishnessGroupBox_->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 127);"));
  reddishnessSpinBox_ = new QDoubleSpinBox(reddishnessGroupBox_);
  reddishnessSpinBox_->setObjectName(QString::fromUtf8("reddishnessSpinBox_"));
  reddishnessSpinBox_->setGeometry(QRect(20, 30, 111, 31));
  reddishnessSpinBox_->setFont(font8);
  reddishnessSpinBox_->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255)"));
  reddishnessSpinBox_->setDecimals(2);
...
// 							   "grayscale-average:", 0, QApplication::UnicodeUTF8));
  ...
  reddishnessGroupBox_->setTitle(QApplication::translate("MainWindow", "Reddishness threshold", 0, QApplication::UnicodeUTF8));
